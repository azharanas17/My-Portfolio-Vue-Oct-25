...
import { Github, Linkedin, Mail, Instagram, MapPin, Send } from 'lucide-vue-next';
...
const props = withDefaults(defineProps<ContactInfo>(), {
  ...
  email: "azharanas173@gmail.com",
  instagram: "azharanas_17",
  location: "Gresik, Indonesia",
  socialLinks: () => [
    { name: "GitHub", url: "https://github.com/azharanas17", icon: "Github" },
    { name: "LinkedIn", url: "https://linkedin.com/in/anas-azhar", icon: "Linkedin" },
    { name: "Email", url: "mailto:azharanas173@gmail.com", icon: "Mail" }
  ]
});
          ...
          <Card class="h-full border border-gray-200 dark:border-gray-700 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-800/50 shadow-lg p-8">
            <CardContent class="p-0">
              <div class="space-y-8">
                ...
                <!-- Instagram -->
                <div v-if="props.instagram" class="flex items-start">
                  <div class="flex-shrink-0 bg-blue-100 dark:bg-blue-900/30 rounded-lg p-3">
                    <Instagram class="h-6 w-6 text-blue-600 dark:text-blue-400" />
                  </div>
                  <div class="ml-4">
